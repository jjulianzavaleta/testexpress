...
use WCWeightVendor\PhpConsole\Handler;
...
class PHPConsoleHandler extends \WCWeightVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @throws Exception
     */
    public function __construct(array $options = array(), \WCWeightVendor\PhpConsole\Connector $connector = null, $level = \WCWeightVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    private function initConnector(\WCWeightVendor\PhpConsole\Connector $connector = null)
    {
        if (!$connector) {
