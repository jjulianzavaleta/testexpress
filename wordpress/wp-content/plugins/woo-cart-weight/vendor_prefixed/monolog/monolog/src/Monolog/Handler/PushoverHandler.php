...
class PushoverHandler extends \WCWeightVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct($token, $users, $title = null, $level = \WCWeightVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \WCWeightVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \WCWeightVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
