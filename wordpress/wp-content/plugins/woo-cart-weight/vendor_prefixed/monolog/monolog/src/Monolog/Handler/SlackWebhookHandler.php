...
class SlackWebhookHandler extends \WCWeightVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($webhookUrl, $channel = null, $username = null, $useAttachment = \true, $iconEmoji = null, $useShortAttachment = \false, $includeContextAndExtra = \false, $level = \WCWeightVendor\Monolog\Logger::CRITICAL, $bubble = \true, array $excludeFields = array())
    {
        parent::__construct($level, $bubble);
        $this->webhookUrl = $webhookUrl;
        $this->slackRecord = new \WCWeightVendor\Monolog\Handler\Slack\SlackRecord($channel, $username, $useAttachment, $iconEmoji, $useShortAttachment, $includeContextAndExtra, $excludeFields, $this->formatter);
    }
    ...
    public function setFormatter(\WCWeightVendor\Monolog\Formatter\FormatterInterface $formatter)
    {
