 ...
 */
class SlackbotHandler extends \WCWeightVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \WCWeightVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
