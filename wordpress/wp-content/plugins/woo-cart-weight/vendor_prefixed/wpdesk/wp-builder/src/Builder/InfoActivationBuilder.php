 ...
 */
class InfoActivationBuilder extends \WCWeightVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \WCWeightVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\WCWeightVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
