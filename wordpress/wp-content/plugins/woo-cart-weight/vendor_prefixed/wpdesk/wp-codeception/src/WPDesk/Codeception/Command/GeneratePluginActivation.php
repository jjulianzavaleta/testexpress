 ...
 */
class GeneratePluginActivation extends \WCWeightVendor\Codeception\Command\GenerateTest implements \WCWeightVendor\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \WCWeightVendor\WPDesk\Codeception\Command\AcceptanceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
