...
if (!\function_exists('WCWeightVendor\\wpdesk_init_wp_notice_ajax_handler')) {
    ...
    {
        return \WCWeightVendor\WPDeskInitWpNoticeAjaxHandler($assetsUrl);
    }
}
...
if (!\function_exists('WCWeightVendor\\wpdesk_wp_notice')) {
    ...
    {
        return \WCWeightVendor\WPDeskWpNotice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
...
if (!\function_exists('WCWeightVendor\\wpdesk_wp_notice_info')) {
    ...
    {
        return \WCWeightVendor\WPDeskWpNoticeInfo($noticeContent, $dismissible, $priority);
    }
}
...
if (!\function_exists('WCWeightVendor\\wpdesk_wp_notice_error')) {
    ...
    {
        return \WCWeightVendor\WPDeskWpNoticeError($noticeContent, $dismissible, $priority);
    }
}
...
if (!\function_exists('WCWeightVendor\\wpdesk_wp_notice_warning')) {
    ...
    {
        return \WCWeightVendor\WPDeskWpNoticeWarning($noticeContent, $dismissible, $priority);
    }
}
...
if (!\function_exists('WCWeightVendor\\wpdesk_wp_notice_success')) {
    ...
    {
        return \WCWeightVendor\WPDeskWpNoticeSuccess($noticeContent, $dismissible, $priority);
    }
}
...
if (!\function_exists('WCWeightVendor\\wpdesk_permanent_dismissible_wp_notice')) {
    ...
    {
        return \WCWeightVendor\WPDeskPermanentDismissibleWpNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
