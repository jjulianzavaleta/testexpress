...
use WCWeightVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \WCWeightVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \WCWeightVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \WCWeightVendor\WPDesk\License\Page\LicensePage($plugin_registry);
