...
namespace WCWeightVendor\WPDesk\Helper\Page;
 ...
 */
class LibraryDebugPage implements \WCWeightVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    const PRIOTITY_LONG_AFTER_ALL_IS_LOADED = 999;
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\WCWeightVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'woo-cart-weight'), \__('Library report', 'woo-cart-weight'), 'manage_options', 'wpdesk-helper-library-report', function () {
