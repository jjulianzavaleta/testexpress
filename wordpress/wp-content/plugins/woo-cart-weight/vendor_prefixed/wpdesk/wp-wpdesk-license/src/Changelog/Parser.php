...
namespace WCWeightVendor\WPDesk\License\Changelog;

use ArrayObject;
use WCWeightVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \WCWeightVendor\WPDesk\License\Changelog\Parser\Line($line);
