...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', __( 'You must be logged in to checkout.', 'poco' ) ) );
	return;
}
...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
		...
		<div class="col2-set" id="customer_details">
			<div class="col-1">
					...
					<?php
						...
						if(WC()->cart->total < 700){
							...
							'options'         => array(
								...
								'rbuton_boleta_propia'    => '  Boleta Nombre Propio  ',
						...
						'label'           => 'RUC',
						'required'        => true,
						'class'           => array('custom-question-ruc-field', 'form-row-first'),
						...
						'class'             => array('custom-question-razonsocial-field', 'form-row-last'),
						...
						echo "<div class='person-client-container' style='display: flex;'>";

						woocommerce_form_field('custom_question_text_dni_client', array(
						'type'            => 'text',
						'label'           => 'DNI',
						'required'        => true,
						'class'           => array('custom-question-dni_client-field', 'form-row-first'),
				...
				<div class="checkout_shipping_fields">
					...
					<div class="woocommerce-info" style="margin-bottom: 1em;">Revise bien su dirección de entrega en la parte superior por favor</div>
					
					<div>
						<?php
						woocommerce_form_field('shipping_address_1', $shipping_fields['shipping_address_1']);
						woocommerce_form_field('shipping_address_2', $shipping_fields['shipping_address_2']);
						woocommerce_form_field('shipping_urbanization', $shipping_fields['shipping_urbanization']);
						woocommerce_form_field('shipping_city', $shipping_fields['shipping_city']);
						woocommerce_form_field('shipping_state', $shipping_fields['shipping_state']);
						...
						woocommerce_form_field('shipping_lat_gmaps', array('label' => 'Lat'));
						woocommerce_form_field('shipping_lng_gmaps', array('label' => 'Long'));
						woocommerce_form_field('shipping_reference', $shipping_fields['shipping_reference']);
						woocommerce_form_field('shipping_delivery_type', array('label' => 'Tipo Entrega'));
						// woocommerce_form_field('valid_map_location', array('label' => 'Valido'));
						?>
					</div>
					...
					<div id="map" margin: 0 0 12px;"></div> -->
				</div>
			...
			<div class="col-2">
				<div class="different_billing_address">
					...
					<div class="woocommerce-billing-fields__field-wrapper">
						<?php
						woocommerce_form_field('billing_state', $billing_fields['billing_state']);
						woocommerce_form_field('billing_city', $billing_fields['billing_city']);
						woocommerce_form_field('billing_address_1', $billing_fields['billing_address_1']);
						?>
					</div>
	...
	<div id="order_review" class="woocommerce-checkout-review-order">
		<h3 id="order_review_heading"><?php esc_html_e( 'Your order', 'poco' ); ?></h3>
