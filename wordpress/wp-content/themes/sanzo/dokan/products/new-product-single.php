...
if ( !isset( $post->ID ) && ! isset( $_GET['product_id'] ) ) {
    wp_die( __( 'Access Denied, No product found', 'sanzo' ) );
}
...
<?php
	...
	if( ! $from_shortcode ){
		sanzo_breadcrumbs_title(true, true, get_the_title());
	}
?>
<?php if( ! $from_shortcode ): ?>
<div class="page-container show_breadcrumb_<?php echo esc_attr($sanzo_theme_options['ts_breadcrumb_layout']) ?>">
                ...
                <h1 class="entry-title">
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="dokan-btn dokan-btn-theme dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Product', 'sanzo' ); ?></a>
                        </span>
                    <?php } ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fa fa-eye-slash"></i> <?php _e( 'Hidden', 'sanzo' ); ?></span>
                    <?php } ?>
                </h1>
            </header><!-- .entry-header -->
            ...
            <div class="product-edit-new-container product-edit-container">
                <?php if ( Dokan_Template_Products::$errors ) { ?>
                    <div class="dokan-alert dokan-alert-danger">
                        ...
                        <?php foreach ( Dokan_Template_Products::$errors as $error) { ?>
                            <strong><?php _e( 'Error!', 'sanzo' ); ?></strong> <?php echo $error ?>.<br>
                        <?php } ?>
                    </div>
                <?php } ?>
                ...
                <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                    <div class="dokan-message">
                        ...
                        <strong><?php _e( 'Success!', 'sanzo' ); ?></strong> <?php _e( 'The product has been saved successfully.', 'sanzo' ); ?>

                        <?php if ( $post->post_status == 'publish' ) { ?>
                            <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php _e( 'View Product &rarr;', 'sanzo' ); ?></a>
                        <?php } ?>
                    </div>
                <?php } ?>
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        <form class="dokan-product-edit-form" role="form" method="post">
                            ...
                            <div class="dokan-form-top-area">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        <label for="post_title" class="form-label"><?php _e( 'Title', 'sanzo' ); ?></label>
                                        <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => __( 'Product name..', 'sanzo' ), 'value' => $post_title ) ); ?>
                                        <div class="dokan-product-title-alert dokan-hide">
                                            <?php _e( 'Please enter product title!', 'sanzo' ); ?>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ( is_array( $product_types ) ): ?>
                                        <div class="dokan-form-group">
                                            <label for="product_type" class="form-label"><?php _e( 'Product Type', 'sanzo' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php _e( 'Choose Variable if your product has multiple attributes - like sizes, colors, quality etc', 'sanzo' ); ?>"></i></label>
                                    ...
                                    <div class="show_if_simple dokan-clearfix">
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            ...
                                            <div class="content-half-part regular-price">
                                                <label for="_regular_price" class="form-label"><?php _e( 'Price', 'sanzo' ); ?>
                                                    <span class="vendor-earning" data-commission="<?php echo dokan_get_seller_percentage( dokan_get_current_user_id(), $post_id ); ?>" data-commission_type="<?php echo dokan_get_commission_type( dokan_get_current_user_id(), $post_id ); ?>">( <?php _e( ' You Earn : ', 'sanzo' ) ?><?php echo get_woocommerce_currency_symbol() ?><span class="vendor-price">0.00</span> )</span>
                                                </label>
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                    <?php dokan_post_input_box( $post_id, '_regular_price', array( 'class' => 'dokan-product-regular-price', 'placeholder' => __( '0.00', 'sanzo' ) ), 'number' ); ?>
                                                </div>
                                            </div>

                                            <div class="content-half-part sale-price">
                                                <label for="_sale_price" class="form-label">
                                                    <?php _e( 'Discounted Price', 'sanzo' ); ?>
                                                    <a href="#" class="sale_schedule <?php echo ($show_schedule ) ? 'dokan-hide' : ''; ?>"><?php _e( 'Schedule', 'sanzo' ); ?></a>
                                                    <a href="#" class="cancel_sale_schedule <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>"><?php _e( 'Cancel', 'sanzo' ); ?></a>
                                                </label>

                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                    <?php dokan_post_input_box( $post_id, '_sale_price', array( 'class' => 'dokan-product-sales-price','placeholder' => __( '0.00', 'sanzo' ) ), 'number' ); ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            <div class="dokan-product-less-price-alert dokan-hide">
                                                <?php _e('Product price can\'t be less than the vendor fee!', 'sanzo' ); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sale_price_dates_fields dokan-clearfix dokan-form-group <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>">
                                            <div class="content-half-part from">
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php _e( 'From', 'sanzo' ); ?></span>
                                                    <input type="text" name="_sale_price_dates_from" class="dokan-form-control datepicker" value="<?php echo esc_attr( $_sale_price_dates_from ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php _e( 'YYYY-MM-DD', 'sanzo' ); ?>">
                                                </div>
                                            </div>

                                            <div class="content-half-part to">
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php _e( 'To', 'sanzo' ); ?></span>
                                                    <input type="text" name="_sale_price_dates_to" class="dokan-form-control datepicker" value="<?php echo esc_attr( $_sale_price_dates_to ); ?>" maxlength="10" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" placeholder="<?php _e( 'YYYY-MM-DD', 'sanzo' ); ?>">
                                                </div>
                                            </div>
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group">
                                            <label for="product_cat" class="form-label"><?php _e( 'Category', 'sanzo' ); ?></label>
                                            <?php
                                            $product_cat = -1;
                                            $term = array();
                                            ...
                                            $category_args =  array(
                                                'show_option_none' => __( '- Select a category -', 'sanzo' ),
                                                'hierarchical'     => 1,
                                                'hide_empty'       => 0,
                                                'name'             => 'product_cat',
                                                'id'               => 'product_cat',
                                        ...
                                        ?>
                                            <div class="dokan-product-cat-alert dokan-hide">
                                                <?php _e('Please choose a category!', 'sanzo' ); ?>
                                            </div>
                                        </div>
                                    <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                        <div class="dokan-form-group">
                                            ...
                                            echo str_replace( '<select', '<select data-placeholder="'.__( 'Select product category', 'sanzo' ).'" multiple="multiple" ', $drop_down_category );
                                            ?>
                                        </div>
                                    <?php endif; ?>

                                    <div class="dokan-form-group">
                                        <label for="product_tag" class="form-label"><?php _e( 'Tags', 'sanzo' ); ?></label>
                                        <?php
                                        ...
                                        echo str_replace( '<select', '<select data-placeholder="'.__( 'Select product tags', 'sanzo' ).'" multiple="multiple" ', $drop_down_tags );
                                ...
                                <div class="content-half-part featured-image">
                                    ...
                                    <div class="dokan-feat-image-upload dokan-new-product-featured-img">
                                        ...
                                        <div class="instruction-inside<?php echo $instruction_class; ?>">
                                            ...
                                            <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php _e( 'Upload a product cover image', 'sanzo' ); ?></a>
                                        </div>
                                                    ...
                                                    if ( $gallery ) {
                                                        foreach ($gallery as $image_id) {
                                                            ...
                                                            <li class="image" data-attachment_id="<?php echo $image_id; ?>">
                                                                ...
                                                                <a href="#" class="action-delete" title="<?php esc_attr_e( 'Delete image', 'sanzo' ); ?>">&times;</a>
                                                            </li>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                                    <li class="add-image add-product-images tips" data-title="<?php _e( 'Add gallery image', 'sanzo' ); ?>">
                            ...
                            <div class="dokan-product-short-description">
                                <label for="post_excerpt" class="form-label"><?php _e( 'Short Description', 'sanzo' ); ?></label>
                            ...
                            <div class="dokan-product-description">
                                <label for="post_content" class="form-label"><?php _e( 'Description', 'sanzo' ); ?></label>
                            ...
                            <input type="hidden" name="dokan_update_product" value="<?php esc_attr_e( 'Save Product', 'sanzo' ); ?>"/>
                            <input type="submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'Save Product', 'sanzo' ); ?>"/>
