        ...
        <div class="dokan-product-edit-area">
            ...
            <header class="dokan-pro-edit-breadcrumb">
                <h1 class="dokan-header-crumb">
                    <span class="dokan-breadcrumb"><a href="<?php echo dokan_get_navigation_url( 'products' ) ?>"><?php _e( 'Products', 'sanzo' ); ?></a> &rarr; </span>
                    <?php echo $post->post_title; ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-label dokan-label-default"><?php _e( 'Hidden', 'sanzo' ); ?></span>
                    <?php } ?>

                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="view-product dokan-btn dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Product', 'sanzo' ); ?></a>
                        </span>
                    <?php } ?>
                </h1>
            </header>
                        ...
                        <div class="dokan-product-edit-left">
                            ...
                            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                                <div class="dokan-message">
                                    ...
                                    <strong><?php _e( 'Success!', 'sanzo' ); ?></strong> <?php _e( 'The product has been updated successfully.', 'sanzo' ); ?>
                                                ...
                                                <div class="show_if_simple">
                                                    <div class="special-price-container">
                                                        ...
                                                        <div class="dokan-form-group dokan-clearfix">
                                                            <div class="dokan-input-group">
                                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                                <?php dokan_post_input_box( $post_id, '_sale_price', array( 'placeholder' => __( 'Special Price', 'sanzo' ) ) ); ?>
                                                            </div>
                                                            <a href="#" class="sale-schedule dokan-right"><?php _e( 'Schedule', 'sanzo' ); ?></a>
                                                        </div>
