...
if ( $rating_count > 0 ) : ?>
	...
	<div class="woocommerce-product-rating">
		...
		<?php if ( comments_open() ) : ?><a href="<?php echo esc_url($review_link); ?>" class="woocommerce-review-link" rel="nofollow"><?php printf( _n( '%s comment', '%s comments', $review_count, 'sanzo' ), '<span class="count">(' . zeroise($review_count, 2) . ')</span>' ); ?></a><?php endif; ?>
	</div>
